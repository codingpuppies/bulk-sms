<div class="header navbar">
    <div class="header-container">
        ...
        <ul class="nav-right">
                ...
                <ul class="dropdown-menu">
                    <li class="pX-20 pY-15 bdB">
                        <i class="ti-bell pR-10">
                                ...
                                class="fsz-sm fw-600 c-grey-900">Notifications</span>
                    </li>
                    <li>
                        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                            ...
                            <li>
                                <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed">
                                                <span>
                                                <span class="fw-500">Moo Doe</span> <span class="c-grey-600">liked your <span
            ...
            <li class="notifications dropdown">
                <span class="counter bgc-blue">3</span> <a href="" class="dropdown-toggle no-after"
                                                           data-toggle="dropdown">
                    <i
                            class="ti-email">
                    </i>
                ...
                <ul class="dropdown-menu">
                    <li class="pX-20 pY-15 bdB">
                        <i class="ti-email pR-10">
                                ...
                                class="fsz-sm fw-600 c-grey-900">Emails</span>
                    </li>
                    <li>
                        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                            <li>
                                    ...
                                    <div class="peer peer-greed">
                                        <div>
                                            <div class="peers jc-sb fxw-nw mB-5">
                                                <div class="peer"><p class="fw-500 mB-0">John Doe</p>
                                                </div>
                                                <div class="peer">
                                                    <small class="fsz-xs">5 mins ago</small>
                                                </div>
                            ...
                            <li>
                                <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed">
                                        <div>
                                            <div class="peers jc-sb fxw-nw mB-5">
                                                <div class="peer"><p class="fw-500 mB-0">Moo Doe</p>
                                                </div>
                                                <div class="peer">
                            ...
                            <li>
                                <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    ...
                                    <div class="peer peer-greed">
                                        <div>
                                            <div class="peers jc-sb fxw-nw mB-5">
                                                <div class="peer"><p class="fw-500 mB-0">Lee Doe</p>
                                                </div>
                                                <div class="peer">
