<div class="sidebar">
    <div class="sidebar-inner">
        ...
        <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item">
                <a class="sidebar-link" href="/write-sms">
                    <span class="icon-holder">
                        <i class="c-purple-500 ti-comment-alt"></i>
                    </span>
                    <span class="title">Write SMS</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="sidebar-link" href="/schedules">
                    <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class="sidebar-link" href="/contacts">
                    <span class="icon-holder">
                        <i class="c-indigo-500 ti-book"></i>
                    </span>
            ...
            <li class="nav-item">
                <a class="sidebar-link" href="/reports">
                    <span class="icon-holder">
                        <i class="c-teal-500 ti-bar-chart"></i>
                    </span>
            ...
            <li class="nav-item"><a class="sidebar-link" href="calendar.html"><span class="icon-holder"><i
                                class="c-deep-orange-500 ti-calendar"></i> </span><span
                            class="title">Calendar</span></a></li>
            ...
            <li class="nav-item dropdown"><a class="dropdown-toggle" href="javascript:void(0);"><span
                            class="icon-holder"><i class="c-teal-500 ti-view-list-alt"></i> </span><span class="title">Multiple Levels</span>
                    <span class="arrow"><i class="ti-angle-right"></i></span></a>
                <ul class="dropdown-menu">
